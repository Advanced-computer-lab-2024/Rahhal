...
export default function SignupAdvertiser() {
  ...
  const { control, handleSubmit, formState: { errors }, setError } = useForm<AdvertiserFormData>({
        ...
        <CardContent className="flex overflow-y-auto h-[calc(100vh-200px)]">
          <form onSubmit={handleSubmit(onSubmit)} className="w-full space-y-4">
            ...
            <Controller
              ...
              render={({ field }) => (
                <div>
                  <Label htmlFor="companyWebsite" className={errors.companyWebsite ? 'text-red-500' : ''}>Company Website</Label>
                  <Input 
                    id="companyWebsite" 
            ...
            <Controller
              ...
              render={({ field }) => (
                <div>
                  <Label htmlFor="hotline" className={errors.hotline ? 'text-red-500' : ''}>Hotline</Label>
                  <Input 
                    id="hotline" 
                    placeholder="Hotline" 
                    {...field} 
                    ...
                    disabled={isSubmitting}
                  />
                  {errors.hotline && <p className="text-red-500 text-sm">{errors.hotline.message}</p>}
                </div>
              )}
            />
            ...
            <Controller
              ...
              render={({ field }) => (
                <div>
                  <Label htmlFor="companyProfile" className={errors.companyProfile ? 'text-red-500' : ''}>Company Profile</Label>
                  <Input 
                    id="companyProfile" 
                    ...
                    disabled={isSubmitting}
                  />
                  {errors.companyProfile && <p className="text-red-500 text-sm">{errors.companyProfile.message}</p>}
                </div>
              )}
            />
