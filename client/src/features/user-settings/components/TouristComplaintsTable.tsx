  ...
  return (
    ...
    {complaints.length === 0 ? (
        <div className="flex flex-col items-center">
          ...
          You haven't filed any complaints yet. If you're experiencing any issues, feel free to let us know by clicking the button below!
          </p>
        ...
        <div className="p-4 border-b border-gray-300">
          <div style={{ backgroundColor: '#1d3c51', padding: '10px', borderRadius: '5px' }}>
            <h2 className="text-lg font-semibold" style={{ color: 'white' }}>My Complaints</h2>
          </div>
