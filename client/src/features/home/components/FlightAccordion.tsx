...
export default function FlightAccordion({offer, userID, isAdult, loggedIn}: FlightAccordionProps) {
                      ...
                      <div className="space-y-4">
                        <div className="flex justify-between items-start">
                          <div>
                            ...
                            <div className="text-sm text-muted-foreground">on : {offer.departure.date}</div>
                            <div className="text-sm text-muted-foreground">at : {offer.departure.time}</div>
                          </div>
                          <div className="text-right">
                            <div className="font-medium">({offer.arrival.code})</div>
                            <div className="text-sm text-muted-foreground">Arrival : </div>
                            <div className="text-sm text-muted-foreground">on : {offer.arrival.date}</div>
                            <div className="text-sm text-muted-foreground">at : {offer.arrival.time}</div>
                          </div>
                        </div>
