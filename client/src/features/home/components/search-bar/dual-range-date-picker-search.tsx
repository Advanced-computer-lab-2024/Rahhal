      ...
      >
        ...
        {open && (
          <div
            ...
            onBlur={handleBlur}
          >
            <div className={cn("flex flex-col w-full h-full p-6",activeType || !hour ? "gap-10" : "")}>
              <div className={"flex w-full justify-center"}>
                <div className="rounded-3xl w-1/3 h-12 flex p-1 bg-gray-300/65">
                    <button className={cn("flex justify-center items-center w-1/2 rounded-3xl hover:bg-gray-300/65 text-md font-medium",activeType?"":"bg-white hover:bg-white border border-gray-300")} onClick={handleDateButton}>Dates</button>
                    <button className={cn("flex justify-center items-center w-1/2 rounded-3xl hover:bg-gray-300/65 text-md font-medium rounded-",activeType?"bg-white hover:bg-white border border-gray-300":"")} onClick={handleMonthButton}>Months</button>
                </div>
              </div>
              ...
              <div style={{display: !activeType ? "flex" : "none"}} className="w-full justify-center">
                <Calendar
                    classNames={{
                    ...
                    components={{
                        ...
                        return (
                            <div className={cn("flex justify-center items-center w-11")}>
                              ...
                              <button
                                  ...
                                  disabled={(activeButton == "checkOut" && (isBefore || isFrom)) || isBeforeToday}
                              >
                                {format(dayDate, "d")}
                              </button>
                            </div>
                      ...
                      Months: ({...props}) => {
                        ...
                        return (<div className={"flex justify-between p-4 w-full h-full"}> {props.children}</div>)
                      },
                    }}/>
              </div>
              {hour&&!activeType&&
                  <div className="px-16 flex justify-between items-center">
                    <TimePicker12HSearchBar setDate={onLeftDateChange} date={leftDate} disabled={!leftDate}/>
                    <TimePicker12HSearchBar setDate={onRightDateChange} date={rightDate} disabled={!rightDate}/>
                  </div>
              }
                </div>
