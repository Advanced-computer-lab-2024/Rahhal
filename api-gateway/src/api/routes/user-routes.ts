...
router.get("/users", grantAccess([Role.ADMIN]), userContoller.getApprovedUsers);
router.get("/users/requests", grantAccess([Role.ADMIN]), userContoller.getUsersPendingRequests);
...
router.patch("/users/:id", grantAccess([Role.ADMIN, Role.ADVERTISER, Role.SELLER, Role.TOURGUIDE, Role.TOURISMGOVERNOR, Role.TOURIST]), userContoller.updateUser);
router.delete("/users/:id", grantAccess([Role.ADMIN, Role.ADVERTISER, Role.SELLER, Role.TOURGUIDE, Role.TOURISMGOVERNOR, Role.TOURIST]), userContoller.deleteUser);
...
router.get("/complaints/:ownerId", grantAccess([Role.TOURIST]), complaintController.getComplaintByOwner);
router.post("/complaints", grantAccess([Role.TOURIST]), complaintController.createComplaint);
router.patch("/complaints/:id", grantAccess([Role.TOURIST, Role.ADMIN]), complaintController.updateComplaint);
