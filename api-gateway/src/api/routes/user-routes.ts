...
router.patch("/users/:id", grantAccess([Role.GUEST,Role.ADMIN, Role.ADVERTISER, Role.SELLER, Role.TOURGUIDE, Role.TOURISMGOVERNOR, Role.TOURIST]), userContoller.updateUser);
